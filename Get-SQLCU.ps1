  ...
  try{
      ...
      else
      {
        ...
        ( $version -eq 2017)
        {
          ...
          $Body_2017="This is a Test. A new Cumulative update for SQL Server 2017 has been released and downloaded to \\uslcnas02\sqlsvrstage\SQL2017\service_pack\$Folder_Name "
          $Body_2019="This is a Test. A new Cumulative update for SQL Server 2019 has been released and downloaded to \\uslcnas02\sqlsvrstage\SQL2019\service_pack\$Folder_Name "
          $From="DoNotReply"
          $To="Your email "
          $Port=25
        ...
        ( $version -eq 2019)
        {
          ...
          $Subject_2017="SQL Cumulative Update $Folder_Name is Now available for SQL Server 2017 "
          $Subject_2019="SQL Cumulative Update $Folder_Name is Now available for SQL Server 2019 "
          $Body_2017="This is a Test. A new Cumulative update for SQL Server 2017 has been released and downloaded to \\YourSharedPath\$Folder_Name "
          $Body_2019="This is a Test. A new Cumulative update for SQL Server 2019 has been released and downloaded to \\YourSharedPath\$Folder_Name "
          $From="DoNotReply"
          $To="Your email "
          $Port=25
            if
